...
def redness(cur):
    ...
    data = [
       # region value redness who
        ...
        ,['NTWest',    17,  0.8, '退新民黨 張慧晶']
        ,['NTWest',    18,  0.8, '蒞地 呂智恆']
        ,['NTWest',    19, -0.7, '前人力 湯詠芝']
